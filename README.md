# gtm_architect_updated_skill

**Category:** 01-framework-core
**Source:** gtm-architect-updated-SKILL.md
...
1. Clone this repository:
   ```bash
   git clone https://github.com/diamitani/gtm_architect_updated_skill-skill.git
   ```
...
2. Import the skill into your agent framework:
   ...
   # For Hermes Agent
   skill_view(name='gtm_architect_updated_skill')
   ```
